...
def semi_reversed_sha1(start_round, chunk, start_a, start_b, start_c, start_d, start_e, e_list):
    a_i_plus_1 = start_a
    b_i_plus_1 = start_b
    c_i_plus_1 = start_c
    d_i_plus_1 = start_d
...
semi_reversed_sha1(start_round, chunk, start_a, start_b, start_c, start_d, start_e, e_list)